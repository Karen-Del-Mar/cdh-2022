            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'aduam.uam.local')), 
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=uam,dc=uam,dc=local'),
                ...
                |
                */
                'username' => env('LDAP_USER', 'username').env('LDAP_ACCOUNT_SUFFIX',''),
                //'username' => env('LDAP_USER', 'username'),
                'password' => env('LDAP_USER_PASSWORD', 'secret'),
